...
import amazon from "../../assets/companylogo/amazone.png";
import cisco from "../../assets/companylogo/cisco.png";
import flipkart from "../../assets/companylogo/flipkart.png";
import google from "../../assets/companylogo/google.png";
import ibm from "../../assets/companylogo/ibm.png";
import insta from "../../assets/companylogo/insta.png";
import microsoft from "../../assets/companylogo/microsoft.png";
import oracle from "../../assets/companylogo/oracle.png";
import pandG from "../../assets/companylogo/pandG.png";
    ...
    <>
      <div className="min-h-screen pb-20">
        ...
        <div className="relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-black">
          ...
          <p className="py-6 text-slate-600 mt-14 text-center font-medium">
            Trusted by leading brands worldwide
          </p>

          <div className="relative mx-auto w-full max-w-5xl overflow-hidden rounded-[2rem] border border-slate-200/80 bg-white/80 px-4 py-5 shadow-[0_20px_60px_-20px_rgba(15,23,42,0.25)] backdrop-blur md:px-6">
            <div className="flex w-max items-center gap-3 md:gap-4 logo-marquee">
              {[...logos, ...logos].map((logo, index) => (
                <div
                  key={`${logo.alt}-${index}`}
                  className="flex min-w-[160px] items-center justify-center rounded-2xl border border-slate-200 bg-white px-4 py-3 shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-md md:min-w-[190px]"
                >
                  <img
                    src={logo.src}
                    alt={logo.alt}
                    className="h-8 w-auto max-w-[120px] object-contain opacity-90 md:h-10"
                  />
                </div>
              ))}
            </div>
